  ...
  return (
    <div className="inventory">
      <div id="inventory-side">
        ...
        <div onClick={Context.player.equipment.mainhand.itemProp.twoHanded ? null : () => selectSlot("shield", null, offhandSlot, (result) => { Context.player.equipment.offhand = result })}>
